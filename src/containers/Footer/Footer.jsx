      ...
      <div className='app__footer-container'>
        ...
        <div className='app__footer-links'>
          <div className='app__footer-logo-section'>
            ...
            <h2 className="white-text">A-spiders Institute</h2> 
          ...
          <div className='app__footer-featured'>
            <h4 className='white-text app__footer-headings'>FEATURED PROGRAMS</h4>
          ...
          <div className='app__footer-learning'>
            <h4 className='white-text'>LEARNING</h4> 
        ...
        <div className='app__footer-contact'>
          <h4 className='white-text'>SUPPORT FORUM</h4>
